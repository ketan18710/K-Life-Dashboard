    ...
    <>
      ...
      <div className="UploadDocuments">
        <div className="header">
          ...
          <button onClick={() => saveData(config)} className="btn2__primary">
            Save
          </button>
        </div>
        <div className="addNewDocument">
          <button
            onClick={() =>
              setTriggers({ ...triggers, uploadingDocument: true })
            }
          ...
          {catalogues &&
            catalogues.map((catalogue, index) => (
              <div className="wrapper">
                <a download href={catalogue.link} className="btn1__primary">
                  {catalogue.title}
                </a>
                <img
                  src={CloseIcon}
                  onClick={() => deleteCatalogue(index)}
                  alt=""
                />
              </div>
            ))}
